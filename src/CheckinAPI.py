...
check_in.schedule_1_hour_checks(scheduler, smartsheet_controller, SMARTSHEET_REPORT_ID, geolocator, sms_controller, CRONJOB_1_CHECKS.get_next_fire_time(None, datetime.now(timezone.utc)) + timedelta(minutes=1))
